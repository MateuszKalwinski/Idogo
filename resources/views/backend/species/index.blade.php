...
<div id="ModuleName" data-moduleName="backendAnimalSpecies">
    ...
    <div class="container-fluid mb-4 min-vh-100">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                ...
                <table id="adminSpeciesTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="ID gatunku">ID</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Nazwa gatunku">Nazwa</th>
                        ...
                        <th colspan="th-sm" data-toggle="tooltip" data-placement="top" title="Dodane przez użytkowania">
                            Dodał
                        </th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Data edycji">Data edycji
                        </th>
                        <th colspan="th-sm" data-toggle="tooltip" data-placement="top" title="Edytowane przez użytkowania">
                            Edytował
                        </th>
                        <th colspan="th-sm" data-toggle="tooltip" data-placement="top" title="Akcje Usuń/Edytuj">Akcje
                        </th>
            ...
            <div class="col-lg-12 col-md-12">
                <table id="adminSpeciesWithGenderTable" class="table table-striped table-bordered" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Nazwa z podziałem na płeć">
                            Nazwa
                        </th>
    ...
    <div class="modal fade" id="addEditSpeciesModal" tabindex="-1" role="dialog" aria-labelledby="Dodaj/Edytuj gatunek"
         aria-hidden="true">
        <div class="modal-dialog modal-lg modal-notify mt-5" role="document">
            <div class="modal-content">
                <div class="modal-header text-center teal lighten-1">
                    <h4 class="modal-title white-text w-100 font-weight-bold py-2"><span id="addEditModalTitle">Dodaj gatunek</span></h4>
    ...
    <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="Usuń gatunek"
        ...
        <div class="modal-dialog modal-lg modal-notify mt-5" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span id="form_result"></span>
                    <p class="text-center">Czy na pewno chcesz usunąć gatunek <span id="animalSpeciesName" class="font-weight-bold"></span></p>
                    <div class="w-50 mx-auto">
                        <div class="d-flex justify-content-around">
                            <button type="button" id="confirm-yes" data-animal-species-id="" class="btn success-color btn-rounded pl-5 pr-5 text-white waves-effect waves-light text-transform-none m-0 mb-3">
                                Tak</button>
