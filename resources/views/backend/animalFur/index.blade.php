...
@section('content')
    ...
    <div id="ModuleName" data-moduleName="backendAnimalFurs">
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <table id="adminAnimalFursTable" class="table table-striped table-bordered" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Nazwa długości futra zwierzaka">
                                Długość futra
                            </th>
        ...
        <div class="modal fade" id="addEditFurModal" tabindex="-1" role="dialog" aria-labelledby="Dodaj/Edytuj długość futra"
             aria-hidden="true">
            <div class="modal-dialog modal-lg modal-notify mt-5" role="document">
                <div class="modal-content">
                    <div class="modal-header text-center teal lighten-1">
                        <h4 class="modal-title white-text w-100 font-weight-bold py-2"><span id="addEditModalTitle">Dodaj długość futra</span></h4>
        ...
        <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="Usuń długość futra"
            ...
            <div class="modal-dialog modal-lg modal-notify mt-5" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <span id="form_result"></span>
                        <p id="animalDeleteText" class="text-center">Czy na pewno chcesz usunąć długość furta <span class="font-weight-bold confirm-animal-fur-name d-none"></span></p>
                        <p id="animalRestoreText" class="text-center">Czy na pewno chcesz przywrócić długość futra <span class="font-weight-bold confirm-animal-fur-name d-none"></span></p>
