        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                <table id="adminUsersTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Zdjęcie użytkownika">Zdjęcie</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="ID użytkownika">ID</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Imię i nazwisko użytkownika">Imię i nazwisko</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Email użytkownika">Email</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Nazwa schroniska">Schronisko</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Liczba dodanych zwierząt bez podziału na status">Ilość zwierząt</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Data dołączenia">Data dołączenia</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Rola użytkownika">Rola</th>
