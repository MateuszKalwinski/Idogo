        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="table-responsive">
                    <table id="adminAnimalsTable" class="table table-striped table-bordered" cellspacing="0"
                           width="100%">
                        <thead>
                        <tr>
                            <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Zdjęcie zwierzaka">
                                Zdjęcie
                            </th>
                            <th class="th-sm" data-toggle="tooltip" data-placement="top" title="ID zwierzaka">ID</th>
                            <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Imie zwierzaka">Imię
                            </th>
                            <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Gatunek zwierzaka">
                                Gatunek
                            </th>
                            <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Rasa zwierzaka">Rasa
                            </th>
                            <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Płeć zwierzaka">Płeć
                            </th>
                            <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Cena zwierzaka">Cena
                            </th>
                            <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Status zwierzaka">
                                Status
                            </th>
