...
<div id="contact" class="container-fluid mb-4 min-vh-100">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                <table id="adminShelterApplicationTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="ID zgłoszenia">ID</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Imie i nazwisko">Imie i nazwisko</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Adres email">Email</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Użytkownik na podstawie przypisanego maila">Użytkownik</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Numer telefonu">Telefon</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Adres schroniska">Adres</th>
                        ...
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Data wysłania wniosku">Data Wysłania wniosku</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Status wniosku">Status</th>
