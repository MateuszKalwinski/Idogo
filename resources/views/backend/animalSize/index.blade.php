...
@section('content')
    ...
    <div id="ModuleName" data-moduleName="backendAnimalSizes">
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="table-responsive">
                        <table id="adminAnimalSizeTable" class="table table-striped table-bordered" cellspacing="0"
                            ...
                            <thead>
                            <tr>
                                <th class="th-sm" data-toggle="tooltip" data-placement="top" title="ID wielkości">ID
                                </th>
                                <th class="th-sm" data-toggle="tooltip" data-placement="top"
                                    title="Nazwa wielkości zwierzaka">
                                    Wielkość
                                </th>
        ...
        <div class="modal fade" id="addEditSizeModal" tabindex="-1" role="dialog"
             aria-labelledby="Dodaj/Edytuj wielkość zwirzaka"
             aria-hidden="true">
            <div class="modal-dialog modal-lg modal-notify mt-5" role="document">
                <div class="modal-content">
                    <div class="modal-header text-center teal lighten-1">
                        <h4 class="modal-title white-text w-100 font-weight-bold py-2"><span id="addEditModalTitle">Dodaj wielkość zwierzaka</span>
                        </h4>
            ...
            <div class="modal-dialog modal-lg modal-notify mt-5" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p id="animalDeleteText" class="text-center">Czy na pewno chcesz usunąć wielkość zwierzaka <span
                                class="font-weight-bold confirm-animal-size-name d-none"></span></p>
                        <p id="animalRestoreText" class="text-center">Czy na pewno chcesz przywrócić wielkość zwierzaka
                            <span class="font-weight-bold confirm-animal-size-name d-none"></span></p>
                        <div class="w-50 mx-auto">
                            <div class="d-flex justify-content-around">
                                <button type="button" id="confirm-yes" data-animal-size-id=""
