...
<div id="contact" class="container-fluid mb-4 min-vh-100">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <table id="adminViolationReportsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="ID zgłoszenia">ID</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Typ zgłoszenia">Typ zgłoszenia</th>
                        <th class="th-sm" data-toggle="tooltip" data-placement="top" title="Nazwa zgłoszenia">Nazwa</th>
                        <th colspan="th-sm" data-toggle="tooltip" data-placement="top" title="Powód zgłoszenia">Powód</th>
                        <th colspan="th-sm" data-toggle="tooltip" data-placement="top" title="Treść zgłoszenia">Treść</th>
                        <th colspan="th-sm" data-toggle="tooltip" data-placement="top" title="Zgłaszający">Zgłoszający</th>
                        <th colspan="th-sm" data-toggle="tooltip" data-placement="top" title="Numer IP zgłaszającego">Numer IP</th>
